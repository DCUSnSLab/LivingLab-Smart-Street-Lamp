...
class matrix(ProcessImpl):
    ...
    def doProc(self):
        ...
        # os.system("sudo /home/pi/Lamp-Code/gateway/rpi-rgb-led-matrix/examples-api-use/text-example --led-cols=64 -f /home/pi/LivingLab-Smart-Street-Lamp/gateway/rpi-rgb-led-matrix/fonts//Galmuri9.bdf --led-slowdown-gpio=3")
