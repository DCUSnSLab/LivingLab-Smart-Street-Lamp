...
int main(int argc, char *argv[]) {
  ...
  for(int j = 0; j < line_cnt; j++) {
    ...
    if(strcmp(temp, "VOC") == 0) {  // done
      ...
      rgb_matrix::DrawText(canvas, font, 1, 13,
    ...
    else if(strcmp(temp, "FINE")==0) { 
          rgb_matrix::DrawText(canvas, font, 6, 14,
    ...
    rgb_matrix::DrawText(canvas, font, 4, 29,
  ...
  RGBMatrix *canvas = RGBMatrix::CreateFromOptions(matrix_options, runtime_opt);
    ...
    rgb_matrix::DrawText(canvas, font, 15, 21,
